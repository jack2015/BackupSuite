...
class FlashImageConfig(Screen):
	...
	def ForceMode(self):
		if platform in ("zgemmahisi3798mv200","zgemmahisi3716mv430"):
			return True
		return False
			...
			if dirname:
				...
				if brand == "dreambox":
					...
					if model in ("h7","sf4008","sf5008","et1x000","et13000","spycat4k","spycat4kcombo") or platformm in ("u5pvr","u5","u51","u52","u53","u54","u56","u532","u533","8100s","gfuturesbcmarm","octagonhisil"):
						...
						no_backup_files = [("kernel_cfe_auto.bin"), ("rootfs.bin"), ("root_cfe_auto.jffs2"), ("root_cfe_auto.bin"), ("oe_kernel.bin"), ("oe_rootfs.bin"), ("kernel_auto.bin"), ("uImage"), ("rootfs.ubi")]
						text += "kernel.bin, rootfs.tar.bz2"
					elif if platform in ("zgemmahisi3798mv200","zgemmahisi3716mv430","u55","u41","u42","u43"):
					...
					elif platform == "gfutureshisil" or brand == "maxytec":
